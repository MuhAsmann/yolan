...
<body class="font-jakarta">
    ...
    <div class="min-h-screen bg-secondary">
        <div class="h-[186px] bg-primary px-2 lg:px-16">
            ...
            <form action="<?= base_url('/save') ?>" method="post" id="form" class="w-full bg-white drop-shadow-lg py-6 lg:py-[69px] px-6 lg:px-[42px] grid grid-cols-1 lg:grid-cols-12 rounded-lg lg:gap-x-[27px] gap-y-6 lg:gap-y-16 justify-center">
                ...
                <div class="col-span-1 lg:col-span-4">
                    <input type="text" class="w-full bg-secondary text-primary font-bold outline-none placeholder:font-bold placeholder:text-primary px-6 pt-[26px] pb-[24px] drop-shadow-lg rounded-lg" placeholder="Nama" value="" name="name" id="name" required>
                </div>
                <div class="col-span-1 lg:col-span-4 flex items-center gap-x-2 drop-shadow-lg px-6 pt-[26px] pb-[24px] rounded-lg w-full bg-secondary">
                    <input type="number" class="w-full bg-transparent text-primary font-bold outline-none placeholder:font-bold placeholder:text-primary" placeholder="Umur" value="" name="umur" id="umur" required>
                    <p class="text-xs text-third font-bold">Tahun</p>
                </div>
                <div class="col-span-1 lg:col-span-4 flex items-center gap-x-2 drop-shadow-lg px-6 pt-[26px] pb-[24px] rounded-lg w-full bg-secondary">
                    <input type="number" class="w-full bg-transparent text-primary font-bold outline-none placeholder:font-bold placeholder:text-primary" placeholder="Tinggi Badan" value="" name="tinggi_badan" id="tinggi_badan" required>
                ...
                <div class="col-span-1 lg:col-span-6 flex items-center gap-x-2 drop-shadow-lg px-6 pt-[26px] pb-[24px] rounded-lg w-full bg-secondary">
                    <input type="number" class="w-full bg-transparent text-primary font-bold outline-none placeholder:font-bold placeholder:text-primary" placeholder="Berat Badan" value="" name="berat_badan" id="berat_badan" required>
                ...
                <div class="flex w-full col-span-1 lg:col-span-6 items-center drop-shadow-lg bg-secondary rounded-md px-6">
                    <select class="w-full outline-none pt-[26px] pb-[24px] rounded-lg bg-transparent text-primary font-bold appearance-none" name="gender" id="gender">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-5 w-full mt-[62px]">
                <?php if (isset($pasien) && count($pasien) > 0) : ?>
                    ...
                    foreach ($pasien as $row) : ?>
                        ...
                        <div class="col-span-1 md:col-span-4 rounded-lg w-full py-[63px] px-[54px] flex flex-col drop-shadow-lg  bg-white relative">
                            ...
                            <div class="grid grid-cols-4 gap-4 mb-[48px]">
                                ...
                                <?php if ($row['aktifitas'] == true) : ?>
                                    <div class="col-span-4 bg-secondary w-full py-[10px] rounded-lg flex  flex-col items-start pl-20 gap-x-6">
                                        <?php
